    ...
    public function registerEvents(): array
    {
        ...
        return [
            AfterSheet::class => function (AfterSheet $event) use (
                ...
                $event->sheet->getStyle('L')->applyFromArray(['numberFormat'=>['formatCode'=>'0']]);
                $event->sheet->getStyle('Y')->applyFromArray(['numberFormat'=>['formatCode'=>'0']]);
                $event->sheet->getStyle('Z')->applyFromArray(['numberFormat'=>['formatCode'=>'0']]);
                $event->sheet->getStyle('AF')->applyFromArray(['numberFormat'=>['formatCode'=>'0']]);
                $event->sheet->getStyle('AG')->applyFromArray(['numberFormat'=>['formatCode'=>'0']]);
