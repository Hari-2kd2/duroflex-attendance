    ...
    public function export()
    {
        ...
        foreach ($employees as $key => $Data) {
            ...
            $dataset[] = [
                ...
                $Data->esi_card_number != 0 ? $Data->esi_card_number : 'NULL',
                $Data->pf_account_number != 0 ? $Data->pf_account_number : 'NULL',
                $Data->bank_name != 0 ? $Data->bank_name : 'NULL',
                $Data->bank_branch != 0 ? $Data->bank_branch : 'NULL',
                $Data->bank_account_no != 0 ? $Data->bank_account_no : 'NULL',
                $Data->bank_of_the_city != 0 ? $Data->bank_of_the_city : 'NULL',
                $Data->ifsc_no != 0 ? $Data->ifsc_no : 'NULL',
                $Data->pan_no != 0 ? $Data->pan_no : 'NULL',
                $Data->aadhar_no != 0 ? $Data->aadhar_no : 'NULL',
                $Data->leave_balance,
                $Data->daily_wage,
                $Data->basic_amt,
                $Data->da_amt,
