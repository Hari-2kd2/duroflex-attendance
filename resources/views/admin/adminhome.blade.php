                    ...
                    <table class="table table-hover table-borderless manage-u-table">
                        <thead>
                            <tr class="">
                                ...
                                <th class="text-left">Total Employee</th>
                                <th class="text-left">Present</th>
                                <th class="text-left">Absent</th>
                                <th class="text-left">CTC in INR</th>
                            </tr>
                        </thead>
                        <tbody>
                            @if ($ctc != null)
                                <tr>
                                    ...
                                    <td class="text-left">{{ DateConvertDBToForm($ctc->date) }}</td>
                                    <td class="text-left">{{ $ctc->employee . " No's" }}</td>
                                    <td class="text-left">{{ $ctc->present . " No's" }}</td>
                                    <td class="text-left">{{ $ctc->absent . " No's" }}</td>
                                    <td class="text-left">{{ number_format($ctc->total_ctc, 2, '.', '') }}</td>
                                </tr>
                            @else
                                <tr>
